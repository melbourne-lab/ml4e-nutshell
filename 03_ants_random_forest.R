...
#' trees. We don't get much improvement in prediction skill beyond about 100
#' trees and by 350 trees the prediction skill is very stable.

# Visualize OOB error for number of trees
plot(rf_pkg_train)

#' We could tune number of trees, mtry, and the minimum node size of trees (a
#' tree stopping rule).
#' 

#' One nice aspect of random forest is the ability to consider variable
#' importance, a measure of how much each variable contributes to predictive
#' skill. Here we see that latitude is the most important predictor.
